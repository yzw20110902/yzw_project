...
public class testMerge {
	...
	public void testHibernate() {
		...
		session.save(new Person("javaMaick"));
		transaction.commit();
		session.close();
	}
	...
	public void testServiceAndDao() {
		...
		ts.save(new Person("人员VVVVVVV"));
		System.out.println(ts.findPerson("402880e75bc3014c015bc30151190001")
				.getName());
